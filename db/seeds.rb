...
proposal3 = Proposal.create!( name: "Partager mes meileures recettes", description: "Je cuisine tous les soirs vers 19h si quelqu'un veut cuisiner avec moi via zoom!", proposer: user2, secondary_category: secondary_category4 )
proposal20 = Proposal.create!( name: "Latin - Grec", description: "Aide en version et en thème ;)", proposer: user1, secondary_category: secondary_category32  )
...
proposal11 = Proposal.create!( name: "Atelier récupération palettes", description: "Hello, passioné de craft et récup, je vous propose un petit atelier pour faire des meubles sympa", proposer: user2, secondary_category: secondary_category8 )
...
proposal_conseil_06 = Proposal.create!( name: name_conseil_06, description: description_conseil_06, proposer: user1, secondary_category: secondary_category10 )
...
proposal5 = Proposal.create!( name: "Conseils jardinage", description: "Passionnée de jardinage, je peux donner des petits conseils botaniques", proposer: user2, secondary_category: secondary_category9 )
...
proposal21 = Proposal.create!( name: "Anglais", description: "English native speaker would be happy to share some time helping young students!", proposer: user2, secondary_category: secondary_category3  )
...
Slot.create!( proposal: proposal9, start_time: DateTime.strptime("06/11/2020 10:00", "%m/%d/%Y %H:%M"))
Slot.create!( proposal: proposal9, start_time: DateTime.strptime("06/11/2020 18:00", "%m/%d/%Y %H:%M"))
Slot.create!( proposal: proposal9, start_time: DateTime.strptime("06/12/2020 14:00", "%m/%d/%Y %H:%M"))
Slot.create!( proposal: proposal9, start_time: DateTime.strptime("06/12/2020 15:00", "%m/%d/%Y %H:%M"))
Slot.create!( proposal: proposal9, start_time: DateTime.strptime("06/12/2020 17:00", "%m/%d/%Y %H:%M"))
Slot.create!( proposal: proposal9, start_time: DateTime.strptime("06/12/2020 19:00", "%m/%d/%Y %H:%M"))
...
Slot.create!( proposal: proposal14, start_time: DateTime.strptime("06/16/2020 11:00", "%m/%d/%Y %H:%M"))
